...
<body>
    ...
    <!-------------------------------------------------------------------- ค้นหา -------------------------------------------------------------------->
        ...
        <div class="row">
            <div class="col-3">
                <form class="d-flex" method="GET" action="list_member.php">
                    <input class="form-control me-2" type="search" name="search_member" placeholder="ค้นหา" aria-label="Search">
                </form>
            </div>
            <div class="col-6">
                ...
                <div class="modal-dialog modal-dialog-md" role="document">
                    <div class="modal-content shadow">
                        <div class="modal-body p-4 text-center">
                            <form class="form-horizontal was-validated" name="add" id="add" method="post" action="member_db.php">
                                <h5 class="mb-0">เพิ่มข้อมูลสมาชิก</h5><br>
