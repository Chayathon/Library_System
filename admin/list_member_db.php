<?php
    ...
    $sql = "SELECT * FROM lib_user WHERE `u_status` LIKE 'member'"; 
...
<table class="table table-hover">
    ...
    <?php foreach($result as $row) { ?>
        <tr align="center">
            ...
            <td><a href="member_db.php?u_id=<?php echo $row['u_id'];?>" data-bs-toggle="modal" data-bs-target="#update<?php echo $row['u_id'];?>"><img src="../img/logo/edit.png" height="16" id="hover"></a></td>
            <td><a href="member_db.php?u_id=<?php echo $row['u_id'];?>" data-bs-toggle="modal" data-bs-target="#delete<?php echo $row['u_id'];?>"><img src="../img/logo/delete.png" height="16" id="hover"></a></td>
        </tr>
                ...
                <div class="modal-dialog modal-dialog-md" role="document">
                    <div class="modal-content shadow">
                        <div class="modal-body p-4 text-center">
                            <form class="form-horizontal was-validated" name="update" id="update" method="post" action="member_db.php">
                                <h5 class="mb-0">แก้ไขข้อมูลสมาชิก</h5><br>
        ...
        <div class="modal fade" id="delete<?php echo $row['u_id'];?>" tabindex="-1" aria-labelledby="delete<?php echo $row['u_id'];?>" aria-hidden="true">
            <div class="modal modal-alert-sm d-block" tabindex="-1" role="dialog" id="modalChoice">
                <div class="modal-dialog modal-dialog-sm" role="document">
                    <div class="modal-content shadow">
                        <div class="modal-body p-4 text-center">
                            <form class="form-horizontal was-validated" name="delete" id="delete" method="post" action="member_db.php">
                                <h5 class="mb-0">ลบข้อมูลสมาชิก</h5><br>
